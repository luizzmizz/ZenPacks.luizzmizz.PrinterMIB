...
class ZenPack(ZenPackBase):
    ...
    new_plugin = "luizzmizz.snmp.PrinterTonerMap"
    #object = app.zport.dmd.Devices.Printer.Laser

    # install the zpython class for the printertoner tab to be displayed
    def install(self, app):
        ZenPackBase.install(self, app)
        dc  = app.zport.dmd.Devices.getOrganizer('Devices/Printer')
        dc._setProperty('zPythonClass', 'ZenPacks.luizzmizz.PrinterMIB.PrinterDevice')
        self.modifyPlugins(app.zport.dmd.Devices.Printer,"add")
    ...
    def remove(self, app, leaveObjects=False):
        self.modifyPlugins(app.zport.dmd.Devices.Printer,"remove")
